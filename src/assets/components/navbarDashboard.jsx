            ...
            <div className="navbar ">
                <div className="navbar-start">
                    ...
                    <div className="p-2">
                        ...
                        <a href="/" className="flex items-center">
                            ...
                            <span className="font-bold text-3xl text-black">TOO</span>
                        </a>
                    </div>
                </div>
                <div className="navbar-center hidden lg:flex ">

                    <ul className="menu menu-horizontal bg-bas-100 rounded-box">
                        <li>
                        <Link to={"/dashboard"}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
                                DASHBOARD</Link>
                ...
                <div className="navbar-end">
                    <div className="flex-none">
                        <ul className="menu menu-horizontal px-1 bg-white rounded-xl">
                            <li>
                                <details>
                                    <summary>
                                        Username
                                    ...
                                    <ul className="bg-primary rounded-t-none">
                                        <li><a className="text-white">Log out</a></li>
                                    </ul>
                                </details>
                            </li>
                        </ul>
